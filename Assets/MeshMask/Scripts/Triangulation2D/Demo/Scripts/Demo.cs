...
namespace mattatz.Triangulation2DSystem.Example {
	...
	public class Demo : MonoBehaviour {
		...
		[SerializeField, Range(1f, 30f)] float angle = 20f;
		[SerializeField, Range(0.1f, 5)] float threshold = 10f;
		...
		void Start () {
			...
			if(debug) {
                ...
                //points.Add(new Vector2(3, 0));
                //points.Add(new Vector2(8, 0));
                //points.Add(new Vector2(5, 3));
                //points.Add(new Vector2(6, 8));
                //points.Add(new Vector2(0, 4));
                //points.Add(new Vector2(-6, 8));
                //points.Add(new Vector2(-5, 3));
                //points.Add(new Vector2(-8, 0));
        ...
        public void SetPointsAndBuild(List<Vector2> pts)
        {
            points = pts;
            Build();
	    }
